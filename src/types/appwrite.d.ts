...
export type Proposals = Models.Row & {
    jobId: string;
    freelancerId: string;
    coverLetter: string;
...
export type Contracts = Models.Row & {
    String: string;
...
export type Milestones = Models.Row & {
    contractId: string;
    description: string;
    amount: number;
    dueDate: string | null;
...
export type ProfileVerifications = Models.Row & {
    profileId: string;
...
export type Connections = Models.Row & {
    followerId: string;
    followingId: string;
...
export type GroupChats = Models.Row & {
    name: string;
...
export type GroupMessages = Models.Row & {
    groupId: string;
    senderId: string;
    content: string;
    contentType: ContentType;
...
export type EscrowTransactions = Models.Row & {
    contractId: string;
    action: Action;
    actorId: string;
    amount: number | null;
...
export type PostInteractions = Models.Row & {
    postId: string;
    userId: string;
    createdAt: string | null;
    interactions: string;
...
export type Portfolios = Models.Row & {
    profileId: string;
    title: string;
    description: string;
    coverImageFileId: string | null;
...
export type Articles = Models.Row & {
    authorId: string;
    title: string;
    slug: string;
    content: string;
...
export type Disputes = Models.Row & {
    contractId: string;
    initiatorId: string;
    respondentId: string;
    reason: string;
...
export type PlatformProposals = Models.Row & {
    proposerId: string;
    title: string;
    description: string;
    proposalType: string;
...
export type PlatformSettings = Models.Row & {
    settingKey: string;
    settingValue: string;
    description: string | null;
...
export type PaymentRequests = Models.Row & {
    requestId: string;
    fromUserId: string;
...
export type VirtualCards = Models.Row & {
    cardId: string;
    userId: string;
    cardNumber: string;
    expiry: string;
...
export type VirtualAccounts = Models.Row & {
    accountId: string;
    userId: string;
