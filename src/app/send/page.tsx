    ...
    <div className="container mx-auto px-4 py-6 max-w-2xl">
      ...
      <>
        ...
        <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Send Crypto</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* From Wallet */}
            <div className="bg-white dark:bg-orange-500/10 dark:border-orange-500/30 rounded-xl border border-neutral-200 p-6">
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-neutral-300 dark:border-orange-500/30 dark:bg-orange-500/5 dark:text-white rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                required
              >
              ...
              {selectedWallet && (
                <p className="text-sm text-neutral-500 dark:text-orange-200 mt-2">
            ...
            <div className="bg-white dark:bg-orange-500/10 dark:border-orange-500/30 rounded-xl border border-neutral-200 p-6">
              ...
              {usdEquivalent > 0 && (
                <p className="text-sm text-neutral-500 dark:text-orange-200 mt-1">
            ...
            <div className="flex space-x-4">
              <Link
                href="/"
                className="flex-1 px-4 py-2 border border-neutral-300 text-neutral-700 dark:text-white dark:border-orange-500/30 dark:hover:bg-orange-500/10 rounded-lg hover:bg-neutral-50 transition-colors text-center"
              >
                Cancel
              </Link>
              <button
                ...
                className="flex-1 px-4 py-2 bg-orange-500 dark:bg-orange-500 text-white rounded-lg hover:bg-orange-600 dark:hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
              >
                {isLoading ? (
                  'Sending...'
                ) : (
